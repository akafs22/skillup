...
class _MainAdminState extends State<MainAdmin> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    // Páginas da BottomNavigationBar
          ...
          Expanded(
            child: TabBarView(
              ...
              children: [
                ...
                _buildAdminInfo(),  // Atualizamos para exibir informações do admin logado
              ],
            ),
          ),
        ],
      ...
      return Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: const [
            ...
            BottomNavigationBarItem(icon: Icon(Icons.person), label: 'Funcionário'),
          ],
        ),
      );
    });
  ...
  // Nova função para exibir informações do administrador logado
    ...
    return Consumer<Logar>(builder: (context, provider, _) {
      return Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Administrador: ${provider.dadosUser["nome"] ?? "Nome não disponível"}',
              style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 10),
            Text('Email: ${provider.dadosUser["email"] ?? "Email não disponível"}'),
          ],
        ),
      );
    });
